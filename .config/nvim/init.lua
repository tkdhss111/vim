...
vim.keymap.set("n", "<F2>", ":w<CR> :make debug<CR>", { noremap = true, silent = true })
vim.keymap.set("n", "<F3>", ":w<CR> :make test<CR>", { noremap = true, silent = true })
vim.keymap.set("n", "<F4>", ":w<CR> :make run<CR>", { noremap = true, silent = true })
vim.keymap.set("n", "<F6>", ":w<CR> :make release<CR>", { noremap = true, silent = true })
...
if vim.fn.exists("g:os") == 0 then
	...
	if is_windows then
		vim.g.os = "Windows"
		--vim.opt.backupdir = "C://Users//" .. username .. "//VIM_BAKUP_FILES//"
		vim.g.python3_host_prog = "C:/Python312/python.exe"
	else
		local uname_output = vim.fn.system("uname")
		vim.g.os = string.gsub(uname_output, "\n", "")
		vim.opt.backupdir = vim.fn.expand("/home/" .. username .. "/VIM_BAKUP_FILES//")
	end
end
vim.opt.backup = true
...
require("lazy").setup({
	...
	{
		"chrisbra/csv.vim",
		ft = { "csv" }, -- only load when editing CSV files
	},
	{
...
vim.api.nvim_create_autocmd("filetype", {
	...
	callback = function()
		...
		--		vim.api.nvim_buf_set_keymap(0, "n", "<F4>", ":w<CR>:AsyncRun make test<CR>", { noremap = true, silent = true })
...
vim.api.nvim_create_autocmd("filetype", {
	...
	callback = function()
		...
		--	vim.api.nvim_buf_set_keymap(0, "n", "<F4>", ":w<CR>:AsyncRun make test<CR>", { noremap = true, silent = true })
		--	vim.api.nvim_buf_set_keymap(0, "n", "<F5>", ":w<CR>:AsyncRun make run<CR>", { noremap = true, silent = true })
		vim.api.nvim_buf_set_keymap(0, "n", "<F6>", ":w<CR>:Make relwithdebinfo<CR>", { noremap = true, silent = true })
	end,
})
...
-- Press F1 to repeat the last Ex command (same as typing @:)
vim.keymap.set("n", "<F1>", ":execute 'normal! @:'<CR>", { noremap = true, silent = true })
